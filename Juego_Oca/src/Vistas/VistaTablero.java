...
public class VistaTablero extends JFrame {
    ...
    /**
     * Metodo que hactiva en la vista una serie de animaciones y detiene otras cuando se encuentra un ganador
     * @param nombre 
     */
    ...
    /**
     * Metodo que hacae visible en caso de ser necesario(Modo 1 Jugador) el cronometro
     */
    ...
    /**
     * Metodo que pone visible el marco que indica a que casilla se va a desplazar el jugador
     * @param casilla 
     */
    ...
    /**
     * Método que administra los diferentes elementos cuando una tirada ha acabado por completo
     */
    ...
    /**
     * Método gracias al cual podemos cambiar la imagen que indica al usuario visualmente quien tiene el turno
     * @param jugadorTurno 
     */
    ...
    /**
     * Método que establece el panel "fondo" con su imagen preestablecida como fondo de la ventana
     */
